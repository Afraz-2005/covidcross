...
var requestOptions = {
  ...
  const totalCases = document.querySelector(".row2-total-cases");
  const newCases = document.querySelector(".row2-new-cases");
  const totalDeaths = document.querySelector(".row2-total-deaths");
  const newDeaths = document.querySelector(".row2-new-deaths");
  const totalRecovered = document.querySelector(".row2-total-recovered");
  const activeCases = document.querySelector(".row2-active-cases");
  const seriousCritical = document.querySelector(".row2-serious-critical");
  const totalTests = document.querySelector(".row2-total-tests");
